...
/**
 * Creates the list of majors and sends it to a JSON file. Most likely we'll do maintenance directly on the JSON file stored in austin-college/data,
 * but I'm keeping this around just in case I need to do quick & dirty maintenance.
 *
 * If you don't have code folding enabled, you are going to cry.
 */
def createAndDump() {
...
""");
    ...
    list << major("Economics", "A major in economics consists of a minimum of eight  course credit units including Economics 111, 301, 302, and five other  courses in economics of which three must be numbered 300 or above.  Economics 111 is a prerequisite for all courses. An economics major also  is required to take Mathematics 151 and either Social Science 120 or  Mathematics 120. It is strongly recommended that students fulfill these  quantitative requirements, along with Economics 301, before beginning  their junior year. Those students contemplating graduate study in  economics are strongly advised to take Mathematics 152, 251, 252, and  301.")
...
Psy 495</td>
    ...
    list << minor("Educational Psychology", """<p>A minor in educational psychology normally consists  of six course credits including three courses in psychology and two  courses in education, with a sixth approved course. The required courses  include:</p>
