...
class MajorDataService {
    ...
    def createAndDump() {
        ...
        list << major("American Studies", """<p>A major in American Studies consists of a minimum of  eight course credit units, including American Studies 231 (or an  approved substitute) and the following:
        </p>
...
""");
        ...
        list << minor("Cognitive Science", """<p>A minor in cognitive science consists of a minimum of five course credit units:</p>
        <ul>
        ...
        list << major("Communication", "A major in communication consists of a minimum of  eight course credit units. At least six course credit units must be  communication courses. Theatre 111, and/or Media Studies 121 also may  count toward the eight courses. Entry into the major typically is  through Comm 112 or 222. At least three courses must be taken at the 300  level or above. Independent Study, Directed Study, or CSOC  may count toward the required eight courses. Students seeking to do an  advanced Directed Study or Independent Study must consult with the  faculty member in the area in which they wish to do advanced work.")
        list << minor("Communication", "A minor in communication consists of a minimum of five course credit units. At least four course credit units must come from Communication courses, with at least two classes numbered 300 or above. Theatre 111 or Media 121 may count as one of those credits. Students seeking a minor should confer with an appropriate departmental faculty member to consider specific courses.")
        list << major("Community Service and Policy", """<p>A minor in community service and policy consists of  six course credits from two different categories and at least three  different disciplines plus an approved internship. The internship must  be pre-approved by the director.</p>
        ...
        """)
        list << minor("English", """<p>A minor in English consists of a minimum of five  course credits, including English 121 and four other English courses  numbered 122 or higher. Students can select courses to emphasize a  variety of interests, including creative writing.</p>""")
        list << major("English with an emphasis on creative writing studies", """<p>A major in English with an emphasis on creative writing studies consists of a minimum of nine course credits numbered 121 or above, distributed as follows:</p>
        ...
        list << minor("Creative writing studies", """<p>A minor in creative writing studies consists of a minimum of five course credits:</p>
        <ul>
        <li>English 136</li>
        <li>Two courses in two different genres of creative writing at the  200-level or above: English 256, 257, or 258, or an approved course with  a substantial creative writing component from another department</li>
        ...
        """)
        list << minor("Environmental Studies", """<p>A minor in environmental studies normally consists  of five course credits, including Environmental Studies 235 and 479, and  three other approved courses from at least two of the college’s  divisions (humanities, natural sciences, social sciences). The minor  must include at least two courses from different departments from the  following list. Pre-approval from the director is required to substitute  any course not listed.</p>
        <p>BIOL 334 Ecology<br />
        BIOL 346 Ecosystem Ecology<br />
        ECO 242 Natural Resources and Environmental Economics<br />
        PHIL 207 Environmental Philosophy<br />

        PHIL 307 Environmental Philosophy<br />
        PHY 240 Atmospheric and Environmental Physics</p>""")
        ...
        list << major("Economics", "A major in economics consists of a minimum of eight  course credit units including Economics 111, 301, 302, and five other  courses in economics of which three must be numbered 300 or above.  Economics 111 is a prerequisite for all courses. An economics major also  is required to take Mathematics 151 and either Social Science 120 or  Mathematics 120. It is strongly recommended that students fulfill these  quantitative requirements, along with Economics 301, before beginning  their junior year. Those students contemplating graduate study in  economics are strongly advised to take Mathematics 152, 251, 252, and  301.</p>")
        list << major("International Economics and Finance", """<p>A major in international economics and finance consists of five components: A Mathematics sequence of Mathematics 151  and either Mathematics 120 or Social Science Statistics 120. An  Economics sequence of Economics 111, Economics 301, and Economics 302. A  BA/Finance sequence of Business Administration 261, Business  Administration/Economics 361and Economics 471. An International sequence  consisting of two courses from Economics 234, Business Administration  368 and Economic 481 and finally a capstone course of Business  Administration 495 or an upper division economics elective.</p>
        ...
        list << minor("Film Studies", """<p>A minor in film studies consists of five course   credits, including Media 121, Media 440, and three other courses   approved for film studies. At least one of the three courses must be at   the 300 level or higher, and at least two of the three must be offered   through a department other than Communication, Media, and Theatre. A   student may repeat Media 440 if the topic differs.</p>
...
<p>Other courses may be appropriate and relevant to students’ specific interests and may be included with director’s approval.</p>""")
        list << major("History", """<p>A major in history consists of a minimum of eight  course credit units, at least three of which are at the 300 level or  above, and no more than four of which are at the 100 level. This work  must include at least one course in each of the following three areas:</p>
<ol>
...
<p>Transfer students are admitted to the major only  after taking placement examinations in theory and history and  auditioning for the faculty member who teaches the major instrument  involved.</p>""")
        ...
        list << major("Political Science", """<p>A major in political science consists of at least  eight course credit units in political science, including Political  Science 495, and at least one course from each of the following groups:</p>
<ul>
...
Psy 495</td>
        ...
        list << minor("Educational Psychology", """<p>A minor in psychology consists of a minimum of five  course credit units, including Psychology 101, 201, plus two approved  psychology electives numbered 200 or above and one psychology elective  numbered 300 or above. Psychology 120 (or Social Science 120 or  Mathematics 120) is a prerequisite for some of the required courses in  the minor.</p>
...
<p>A minor in educational psychology normally consists  of six course credits including three courses in psychology and two  courses in education, with a sixth approved course. The required courses  include:</p>
...
<p>The director must pre-approve the sixth course that is intended to be  a special bridging course that assists the student in linking knowledge  gained from the required courses with a specific interest. Given that a  course in Life Span Psychology is required for teacher certification,  it is required for the Educational Psychology minor; PSY  330 Educational Psychology may be taken for the approved sixth course.  Courses for the educational psychology minor may not be taken S/D/U.  Students may not major in psychology and minor in educational  psychology. We recommend that students take statistics and methods in  consecutive semesters.</p>""", "Psychology")
        ...
        list << major("Western Intellectual Tradition", """<p>A minor in western intellectual tradition consists of a minimum of six course credit units in at least three disciplines:</p>
<ul>
