...
class MajorDataService {
    ...
    def createAndDump() {
        ...
        list << major("American Studies", """<p>A <strong>major in American Studies</strong> consists of a minimum of  eight course credit units, including American Studies 231 (or an  approved substitute) and the following:
        </p>
...
""");
        ...
        list << major("Communication", "A <strong>major in communication</strong> consists of a minimum of  eight course credit units. At least six course credit units must be  communication courses. Theatre 111, and/or Media Studies 121 also may  count toward the eight courses. Entry into the major typically is  through Comm 112 or 222. At least three courses must be taken at the 300  level or above. Independent Study, Directed Study, or CSOC  may count toward the required eight courses. Students seeking to do an  advanced Directed Study or Independent Study must consult with the  faculty member in the area in which they wish to do advanced work.")
        list << minor("Communication", "A <strong>minor in communication</strong> consists of a minimum of five course credit units. At least four course credit units must come from Communication courses, with at least two classes numbered 300 or above. Theatre 111 or Media 121 may count as one of those credits. Students seeking a minor should confer with an appropriate departmental faculty member to consider specific courses.")
        list << major("Community Service and Policy", """<p>A <strong>minor in community service and policy</strong> consists of  six course credits from two different categories and at least three  different disciplines plus an approved internship. The internship must  be pre-approved by the director.</p>
        <p><strong>Category One</strong> – Students are required to take three course credits from at least two different disciplines from the following:</p>
        <ul>
        ...
        <p><strong>Category Two</strong> – Students are required to take three course credits  from at least two different disciplines from the following list:</p>
        <ul>
        ...
        """)
        list << minor("English", """<p><strong>A minor in English</strong> consists of a minimum of five  course credits, including English 121 and four other English courses  numbered 122 or higher. Students can select courses to emphasize a  variety of interests, including creative writing.</p>""")
        list << major("English with an emphasis on creative writing studies", """<p><strong>A major in English with an emphasis on creative writing studies</strong> consists of a minimum of nine course credits numbered 121 or above, distributed as follows:</p>
        ...
        list << minor("Creative writing studies", """<p><strong>A minor in creative writing studies</strong> consists of a minimum of five course credits:</p>
        <ul>
        <li>English 136</li>
        <li>Two courses in two different genres of creative writing at the  200-level or above: English 256, 257, or 258, or an approved course with  a substantial creative writing component from another department</li>
        ...
        list << major("Environmental Studies", """<p><strong>A major in environmental studies</strong> normally consists  of 10 course credits including Environmental Studies 235 and 479,  Economics 242, Philosophy 207 or 307, an approved project (see below),  and one of the following: Biology 334, Biology 346, or Physics 240. In  addition to the college requirement that a major include at least three  courses above 300, the environmental studies major requires at least six  courses above 200. The following courses are some of the Austin College  courses approved for the environmental studies major, with the  exception that Biology 115 and Economics 111 may be counted only if  taken to satisfy a prerequisite for another approved course on this  list. The director must approve any other courses chosen as electives  for the environmental studies major.</p>
        <p><strong>BIOL 115</strong> Evolution, Behavior, and Ecology<br />
        <strong>BIOL 334</strong> Ecology (Prerequisite: BIOL 115)<br />

        <strong>BIOL 346</strong> Ecosystem Ecology (Prerequisites – see course description)<br />
        <strong>CHEM 101</strong> Environmental Chemistry<br />
        <strong>ECO 111</strong> Principles of Economics<br />
        <strong>ECO 242</strong> Natural Resources and Environmental Economics (Prerequisite: ECO 111)<br />
        <strong>ENVS 235</strong> Introduction to Environmental Studies<br />

        <strong>ENVS 230</strong> Globalization (See note at ENVS 330)<br />
        <strong>ENVS 330</strong> Globalization  (Prerequisites – see course description. Environmental Studies majors  should enroll in 330 rather than 230 when feasible.)<br />
        <strong>ENVS 479</strong> Environmental Policy (Prerequisites – see course description)<br />
        <strong>HIST 250</strong> European Environmental History<br />
        <strong>MATH 120</strong> Elementary Statistics or PSY 120 or SSCI 120<br />

        <strong>PHIL 207</strong> Environmental Philosophy (see note at PHIL 307)<br />
        <strong>PHIL 307</strong> Environmental  Philosophy (Prerequisites – see course description. Environmental  Studies majors should enroll in 307 rather than 207 when feasible.)<br />
        <strong>PHY 101</strong> The Day After Tomorrow: Global Climate and Extreme Weather<br />
        <strong>PHY 240</strong> Atmospheric and Environmental Physics (Prerequisites – see course description)<br />
        <strong>PSY 120</strong> Statistics for Psychologists or MATH 120 or SSCI 120<br />

        <strong>PSY 222</strong> Environmental Psychology<br />
        <strong>SSCI 120</strong> Social Science Statistics or MATH 120 or PSY 120</p>
        <p>Students who are interested in the environmental studies major are  strongly encouraged to consult the program director at their earliest  convenience, especially because eligibility for particular postgraduate  opportunities may require that students complete additional courses that  are not required for the environmental studies major. Students also are  encouraged to study the webpage of the <a href="http://www.austincollege.edu/envstudies"><strong>environmental studies</strong></a> program.</p>
        ...
        """)
        list << minor("Environmental Studies", """<p><strong>A minor in environmental studies</strong> normally consists  of five course credits, including Environmental Studies 235 and 479, and  three other approved courses from at least two of the college’s  divisions (humanities, natural sciences, social sciences). The minor  must include at least two courses from different departments from the  following list. Pre-approval from the director is required to substitute  any course not listed.</p>
        <p><strong>BIOL 334</strong> Ecology<br />
        <strong>BIOL 346</strong> Ecosystem Ecology<br />
        <strong>ECO 242</strong> Natural Resources and Environmental Economics<br />
        <strong>PHIL 207</strong> Environmental Philosophy<br />

        <strong>PHIL 307</strong> Environmental Philosophy<br />
        <strong>PHY 240</strong> Atmospheric and Environmental Physics</p>""")
        list << minor("Exercise and Sport Science", """A minor in exercise and sport science consists of a minimum of five course credit units, including Exercise and Sport Science 121, 495, and at least one other course numbered 300 or higher.
        ...
        list << major("Economics", "<strong>A major in economics</strong> consists of a minimum of eight  course credit units including Economics 111, 301, 302, and five other  courses in economics of which three must be numbered 300 or above.  Economics 111 is a prerequisite for all courses. An economics major also  is required to take Mathematics 151 and either Social Science 120 or  Mathematics 120. It is strongly recommended that students fulfill these  quantitative requirements, along with Economics 301, before beginning  their junior year. Those students contemplating graduate study in  economics are strongly advised to take Mathematics 152, 251, 252, and  301.</p>")
        list << major("International Economics and Finance", """<p><strong>A major in international economics and finance</strong> consists of five components: A Mathematics sequence of Mathematics 151  and either Mathematics 120 or Social Science Statistics 120. An  Economics sequence of Economics 111, Economics 301, and Economics 302. A  BA/Finance sequence of Business Administration 261, Business  Administration/Economics 361and Economics 471. An International sequence  consisting of two courses from Economics 234, Business Administration  368 and Economic 481 and finally a capstone course of Business  Administration 495 or an upper division economics elective.</p>
        <p>In addition, the student must complete a semester of study or an  approved internship outside the United States and study in another  modern language through the 236 level or equivalent.</p>""", "Economics")
        list << minor("Film Studies", """<p><strong>A minor in film studies</strong> consists of five course   credits, including Media 121, Media 440, and three other courses   approved for film studies. At least one of the three courses must be at   the 300 level or higher, and at least two of the three must be offered   through a department other than Communication, Media, and Theatre. A   student may repeat Media 440 if the topic differs.</p>
        <p><strong>Courses Approved for the Film Studies Minor:</strong></p>
        <ul>
...
<li>Disciplinary courses approved for the western intellectual  tradition minor are listed collectively in the course schedule each  term.</li>
    ...
    def toMap(name, isMajor, description, department = name) {
        [name: name, isMajor: isMajor, department: department, description: description]
    }

    def major(name, description, department = name) {
        [name: name, isMajor: true, department: department, description: description]
    }

    def minor(name, description, department = name) {
        [name: name, isMajor: false, department: department, description: description]
    }
}
